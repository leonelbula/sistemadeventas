		...
		<div class="box">
			...
			<div class="box-body">
				...
				<div class="panel panel-default">
					<div class="panel-heading"><h3>Informe de Ganancias y Pedidad</h3></div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-xs-6">
						...
						<div class="small-box bg-yellow">
							...
							<a href="<?= URL_BASE ?>gastos/reportecompra" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
