...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<th style="border: 1px solid #666; background-color:white; width:80px; text-align:center; font-weight: bold">Codigo Fabricante</th>							
		<th style="border: 1px solid #666; background-color:white; width:25px; text-align:center; font-weight: bold">-</th>
		<th style="border: 1px solid #666; background-color:white; width:40px; text-align:center; font-weight: bold">------</th>
		<th style="border: 1px solid #666; background-color:white; width:80px; text-align:center; font-weight: bold">Cantidad Actual</th>		
...
$bloque4 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #9B9B9B; color:#333; background-color:white; width:25px; text-align:center">
			-
			</td>
